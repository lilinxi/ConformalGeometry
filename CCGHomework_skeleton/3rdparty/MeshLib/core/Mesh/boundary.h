    ...
    public:
        ...
        */
        ...
        /*!
            ...
            \param pMesh  pointer to the current mesh
        */
        CLoop(CBaseMesh<CVertex, CEdge, CFace, CHalfEdge> *pMesh) {
            m_pMesh = pMesh;
            m_length = 0;
            m_pHalfedge = NULL;
        };
...
*/
    template<typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
    void CBoundary<CVertex, CEdge, CFace, CHalfEdge>::_bubble_sort(
            std::vector<CLoop<CVertex, CEdge, CFace, CHalfEdge> *> &loops) {
...
*/
    ...
    void CLoop<CVertex, CEdge, CFace, CHalfEdge>::write(const char *file_name) {
        ...
        for (typename std::list<CHalfEdge *>::iterator hiter = m_halfedges.begin();
             hiter != m_halfedges.end(); hiter++) {
            CHalfEdge *pH = *hiter;
