...
//        pH[0]->angle() = _inverse_cosine_law(((M::CEdge * )(pH[1]->edge()))->length(),
//                                             ((M::CEdge * )(pH[2]->edge()))->length(),
//                                             ((M::CEdge * )(pH[0]->edge()))->length());
//        pH[1]->angle() = _inverse_cosine_law(m_pMesh->halfedgeEdge(pH[0])->length(),
//                                             m_pMesh->halfedgeEdge(pH[2])->length(),
//                                             m_pMesh->halfedgeEdge(pH[1])->length());
//        pH[2]->angle() = _inverse_cosine_law(m_pMesh->halfedgeEdge(pH[1])->length(),
//                                             m_pMesh->halfedgeEdge(pH[0])->length(),
//                                             m_pMesh->halfedgeEdge(pH[2])->length());
//    }
...
//            pE->weight() = 1.0 / std::tan(((M::CHalfEdge * )(half_edge))->angle());
//        } else {
//            pE->weight() = 1.0 / std::tan(((M::CHalfEdge * )(pE->halfedge(0)))->angle());
//            pE->weight() += 1.0 / std::tan(((M::CHalfEdge * )(pE->halfedge(1)))->angle());
//        }
//    }
//}
//
